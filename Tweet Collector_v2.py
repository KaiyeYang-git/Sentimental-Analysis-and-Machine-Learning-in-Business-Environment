...
first_time_1=time_builder(start_date_1_2,end_date_1_2)[:-1]
second_time_1=time_builder(start_date_1_2,end_date_1_2)[1:]
...
for start_time, end_time in zip(rfc_first_time,rfc_second_time):
    ...
    tweets_datasource.to_csv('/home2/hzhx55/Dissertation/TwData_300.csv',sep=',', mode='a',encoding='utf_8')